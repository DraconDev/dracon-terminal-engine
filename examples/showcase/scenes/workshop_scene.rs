...
impl WorkshopScene {
    ...
    fn render_help(&self, plane: &mut Plane, area: Rect) {
        ...
        let lines = [
            ("╭────────────────────────────────────────────────╮", true),
            ("│       Widget Workshop Help                     │", true),
            ("├────────────────────────────────────────────────┤", true),
            ("│  ↑/↓       Switch between widgets              │", false),
            ("│  ←/→       Adjust numeric properties            │", false),
            ("│  Space     Toggle boolean properties            │", false),
            ("│  Enter     Activate/press widget                 │", false),
