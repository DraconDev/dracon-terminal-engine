...
pub use stat_widget::{create_stat_widget, register as register_stat_widget, STAT_WIDGET_NAME};
pub use welcome_widget::{create_welcome_widget, register as register_welcome_widget, WELCOME_WIDGET_NAME};
